          ...
          <div className="bg-white p-8 rounded-lg shadow-md mb-16">
            ...
            <div className="space-y-4">
              ...
              <div className="pb-4 hover:bg-blue-50 transition-all duration-300 transform hover:scale-[1.02] rounded-lg cursor-pointer" onClick={() => toggleQuestion('q4')}>
                ...
                {expandedQuestion === 'q4' && (
                  <p className="text-gray-600 mt-2">You can call us at +91 87675 86798, fill the quote form on our website, or visit our office in Buldhana for a free survey and quotation.</p>
                )}
              </div>
            </div>
          </div>
