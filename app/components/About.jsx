            ...
            <div className="order-1 lg:order-1">
              <div className="relative overflow-hidden rounded-lg shadow-md">
                <img 
                  ...
                  alt="Professional Packers and Movers Team"
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <div className="bg-blue-600 bg-opacity-90 backdrop-blur-sm rounded-lg px-4 py-2">
                    <p className="text-sm font-semibold">Expert Moving Team</p>
                    <p className="text-xs opacity-90">Professional & Experienced</p>
                  </div>
                </div>
              </div>
            </div>
